...
from utils.amr_parsing.amr_concepts import Entity, Date, Score, Quantity, Ordinal, Polarity, Polite, URL
...
class Recategorizer:
    ...
    def _build_utils(self):
        print('Building name_type_cooccur_counter and wiki_span_cooccur_counter...')
        for _ in self.recategorize_file(self.train_data):
            pass
        self.build_entity_map = True
        print('Done.\n')
        print('Building entity_type_cooccur_counter...')
