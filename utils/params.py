...
from utils.algorithms import dict_merge
...
class Params(object):
    ...
    def __eq__(self, other):
        if not isinstance(other, Params):
            print('The params you compare is not an instance of Params. ({} != {})'.format(
        ...
        if len(this_flat_params) != len(other_flat_params):
            print('The numbers of parameters are different: {} != {}'.format(
        ...
        for k, v in this_flat_params.items():
            ...
            if k not in other_flat_params:
                print('The parameter "{}" is not specified.'.format(k))
                same = False
            elif other_flat_params[k] != v:
                print('The values of "{}" not not the same: {} != {}'.format(
